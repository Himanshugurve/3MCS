...
/* ─────────────────────────────────────────────
   Success Popup Component - Responsive
───────────────────────────────────────────── */
        ...
        >
            ...
            >
                ...
                <div className="flex justify-center mb-4 sm:mb-6 relative">
                    ...
                    >
                        <FaCheckCircle size={32} color={C.white} className="sm:hidden" />
                        <FaCheckCircle size={40} color={C.white} className="hidden sm:block" />

                        {/* Ripple effect */}
                        <div
                            className="absolute inset-0 rounded-full animate-ping"
                            style={{
                                background: `${C.brandOrange}40`,
                            }}
                        />
                    </div>
                </div>
                ...
                <div
                    ...
                    style={{ background: `${C.accentBlue}20` }}
                >
                    <div
                        className="h-full"
                        style={{
...
/* ─────────────────────────────────────────────
   Floating Particle Component - Responsive
───────────────────────────────────────────── */
...
function ContactForm() {
    ...
    const InputField = ({ name, type = 'text', placeholder, icon: Icon }) => (
        <div className="relative">
            <div className="relative">
                <div
                    className="absolute left-3 sm:left-4 top-1/2 transform -translate-y-1/2 transition-all duration-300"
                    style={{
                        color: focusedField === name ? C.brandOrange : C.accentBlue,
                ...
                <input
                    ...
                    autoComplete="off"
                    spellCheck={false}
                    className="w-full pl-10 sm:pl-12 pr-3 sm:pr-4 py-3 sm:py-4 rounded-xl sm:rounded-2xl transition-all duration-300 text-sm sm:text-base"
                    style={{
                        border: `2px solid ${errors[name] && touched[name]
                            ? '#EF4444'
                            : focusedField === name
                                ? C.brandOrange
                                : `${C.accentBlue}15`
                        ...
                        outline: 'none',
                        background: focusedField === name ? `${C.brandOrange}05` : C.white,
                        boxShadow: focusedField === name ? `0 0 0 4px ${C.brandOrange}10` : 'none',
                    }}
                />
            </div>
            {errors[name] && touched[name] && (
                <p className="text-[10px] sm:text-xs mt-1.5 sm:mt-2 ml-1 font-semibold flex items-center gap-1" style={{ color: '#EF4444' }}>
        ...
        <>
            <form onSubmit={handleSubmit} className="space-y-4 sm:space-y-5">
                ...
                <div className="relative">
                    <div className="relative">
                        <div
                            className="absolute left-3 sm:left-4 top-3 sm:top-4 transition-all duration-300"
                            style={{
                                color: focusedField === 'message' ? C.brandOrange : C.accentBlue,
                                opacity: focusedField === 'message' ? 1 : 0.5,
                            }}
                        >
                            <FaPaperPlane size={16} className="sm:hidden" />
                            <FaPaperPlane size={18} className="hidden sm:block" />
                        </div>
                        <textarea
                            name="message"
                            ...
                            autoComplete="off"
                            spellCheck={false}
                            className="w-full pl-10 sm:pl-12 pr-3 sm:pr-4 py-3 sm:py-4 rounded-xl sm:rounded-2xl resize-none transition-all duration-300 text-sm sm:text-base"
                            style={{
                                border: `2px solid ${errors.message && touched.message
                                    ? '#EF4444'
                                ...
                                outline: 'none',
                                background: focusedField === 'message' ? `${C.brandOrange}05` : C.white,
                                boxShadow: focusedField === 'message' ? `0 0 0 4px ${C.brandOrange}10` : 'none',
                            }}
                        />
                    </div>
                ...
                <div className="flex justify-center">
                    <button
                        ...
                        className="group w-full sm:w-auto px-8 sm:px-12 md:px-16 py-3.5 sm:py-4 md:py-5 rounded-xl sm:rounded-2xl font-bold text-base sm:text-lg transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed relative overflow-hidden"
                        style={{
                            background: C.brandOrange,
                            color: C.white,
                        }}
                    >
                        ...
                        <div
                            ...
                            style={{
                                background: `linear-gradient(135deg, ${C.primaryLight} 0%, ${C.brandOrange} 100%)`,
                            }}
                        />
                    </button>
                </div>
...
/* ─────────────────────────────────────────────
   Contact Info Card Component - Responsive
───────────────────────────────────────────── */
function ContactInfoCard({ icon: Icon, label, value, href, type }) {
    ...
    return (
        <a
            ...
            style={{
                background: hovered
                    ? `linear-gradient(135deg, ${gradient}10 0%, ${gradient}05 100%)`
                    : `${C.accentBlue}05`,
                border: `2px solid ${hovered ? `${gradient}40` : `${C.accentBlue}10`}`,
                transform: hovered ? 'translateY(-4px) scale(1.02)' : 'translateY(0) scale(1)',
                boxShadow: hovered ? `0 12px 30px ${gradient}20` : '0 4px 12px rgba(0,0,0,0.05)',
            }}
        ...
        >
            <div className="flex items-start gap-3 sm:gap-4">
                <div
                    className="w-12 h-12 sm:w-14 sm:h-14 rounded-lg sm:rounded-xl flex items-center justify-center flex-shrink-0 transition-all duration-500"
                    style={{
                        background: hovered
                            ? `linear-gradient(135deg, ${gradient} 0%, ${gradient}DD 100%)`
                            : `${gradient}15`,
                        color: hovered ? C.white : gradient,
                        transform: hovered ? 'rotate(5deg) scale(1.1)' : 'rotate(0deg) scale(1)',
                        boxShadow: hovered ? `0 6px 12px ${gradient}30` : 'none',
                    }}
                >
                ...
                <div className="flex-1 min-w-0">
                    <p
                        className="text-[10px] sm:text-xs font-bold uppercase tracking-wider mb-1 sm:mb-1.5"
                        style={{ color: C.accentBlue }}
                    >
                        {label}
                    </p>
                    <p
                        className="font-bold text-sm sm:text-base break-words transition-colors duration-300"
                        style={{ color: hovered ? gradient : C.black }}
                    >
                        {value}
                    </p>
                </div>
...
/* ─────────────────────────────────────────────
   Main Contact Section - Fully Responsive
───────────────────────────────────────────── */
export default function ContactUs() {
    ...
    return (
        <section
            id="contact"
            ref={sectionRef}
            className="relative py-12 sm:py-16 md:py-5 lg:py-24 overflow-hidden"
            style={{
                background: `linear-gradient(180deg, ${C.white} 0%, #F8F9FF 50%, ${C.white} 100%)`,
            }}
        >
            ...
            <div className="absolute inset-0 pointer-events-none overflow-hidden">
                {/* Large gradient orbs */}
                <div
                    className="absolute -top-40 -right-40 w-full max-w-xl sm:max-w-2xl aspect-square rounded-full blur-3xl opacity-15 sm:opacity-20"
                    style={{ background: `radial-gradient(circle, ${C.primaryLight} 0%, transparent 70%)` }}
                />
                <div
                    className="absolute -bottom-40 -left-40 w-full max-w-xl sm:max-w-2xl aspect-square rounded-full blur-3xl opacity-10 sm:opacity-15"
                ...
                {/* Grid pattern */}
                <svg className="absolute inset-0 w-full h-full opacity-15 sm:opacity-20" xmlns="http://www.w3.org/2000/svg">
                    <defs>
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                <div className="max-w-7xl mx-auto">
                    ...
                    >
                        ...
                        <p className="text-sm sm:text-base md:text-lg lg:text-xl leading-relaxed px-4" style={{ color: C.accentBlue }}>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-5 gap-6 sm:gap-8 mb-10 sm:mb-12 md:mb-16">
                        ...
                        >
                            ...
                            >
                                ...
                                <div className="mb-5 sm:mb-6">
                                    <p className="text-xs sm:text-sm font-bold uppercase tracking-wider mb-3 sm:mb-4" style={{ color: `${C.white}70` }}>
                                        Follow Us
                                    </p>
                                        ...
                                        {SOCIAL_LINKS.map((social) => {
                                            ...
                                            return (
                                                <a
                                                    ...
                                                    className="group w-10 h-10 sm:w-12 sm:h-12 rounded-lg sm:rounded-xl flex items-center justify-center transition-all duration-300 hover:scale-110 hover:-translate-y-1"
                                                    style={{
                                                    ...
                                                    title={social.name}
                                                >
                                                    {SocialIcon && <SocialIcon size={18} className="sm:hidden" />}
                                                    {SocialIcon && <SocialIcon size={20} className="hidden sm:block" />}
                                                </a>
                                            );
                                        })}
                                    </div>
                        ...
                        {/* Right Column - Contact Form (3 columns) - Responsive */}
                        <div
                        ...
                        >
                            <div
                                className="rounded-2xl sm:rounded-3xl p-6 sm:p-8 md:p-10 h-full"
                                style={{
                                    background: C.white,
                    ...
                    >
                        <div className="relative" style={{ height: '300px' }}>
                            ...
                            {/* Enhanced Map Overlay - Responsive */}
                            <div
                            ...
                            >
                                <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 sm:gap-6">
                                    <div className="flex items-center gap-3 sm:gap-4 md:gap-5">
                                        ...
                                        >
                                            <FaMapMarkerAlt size={20} color={C.white} className="sm:hidden" />
                                            <FaMapMarkerAlt size={24} color={C.white} className="hidden sm:block md:hidden" />
                                            <FaMapMarkerAlt size={28} color={C.white} className="hidden md:block" />
                                        </div> */}
                                        <div>
                                            <p className="font-black text-base sm:text-lg md:text-xl mb-0.5 sm:mb-1" style={{ color: C.primaryDark }}>
                                                {COMPANY_INFO.name}
                                            </p>
                                    ...
                                    <a
                                        ...
                                        target="_blank"
                                        rel="noopener noreferrer"
                                        className="group px-4 sm:px-5 md:px-6 py-2 sm:py-2.5 md:py-3 rounded-lg sm:rounded-xl font-bold text-xs sm:text-sm transition-all duration-300 hover:scale-105 flex items-center gap-2 whitespace-nowrap w-full sm:w-auto justify-center"
                                        style={{
                                            background: C.brandOrange,
                                            color: C.white,
                                            boxShadow: `0 4px 16px ${C.brandOrange}40`,
                                        }}
                                    >
                                        Get Directions
